...
257,0,0,6,69,0,5,288,0,0,3,3,0,2,8,68,65,78,73,69,76,65,82,1,97,0,0,1,97,0,0,1,
3,0,0,
};
...
void update_Negocio_FML(TPSVCINFO *rqst)
{
   ...
   memset(t_Nombre, 0x00, sizeof(t_Nombre));
   memset(t_Tamano, 0x00, sizeof(t_Tamano));
   ...
   if (Fget32(fbfr, TAMANO, 0, t_Tamano, 0) < 0)
   {
      userlog("Error Fget32(TAMANO): %s", Fstrerror32(Ferror32));
      tpreturn(TPFAIL, 0, rqst->data, 0L, 0);
   }
   userlog("Tamano: [%s]", t_Tamano);
...

{
   ...
   sqlstm.sqladtp = &sqladt;
   sqlstm.sqltdsp = &sqltds;
   sqlstm.stmt = "update habitaciones  set Nombre=:b0,Tamano=:b1 where idHab\
itacion=:b2";
   sqlstm.iters = (unsigned int  )1;
   ...
   sqlstm.sqadto[0] = (unsigned short )0;
   sqlstm.sqtdso[0] = (unsigned short )0;
   sqlstm.sqhstv[1] = (unsigned char  *)t_Tamano;
   sqlstm.sqhstl[1] = (unsigned long )20;
   sqlstm.sqhsts[1] = (         int  )0;
   sqlstm.sqindv[1] = (         short *)0;
   sqlstm.sqinds[1] = (         int  )0;
   ...
   sqlstm.sqadto[1] = (unsigned short )0;
   sqlstm.sqtdso[1] = (unsigned short )0;
   sqlstm.sqhstv[2] = (unsigned char  *)&t_idHabitacion;
